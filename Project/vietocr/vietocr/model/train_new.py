...
from vietocr.optim.labelsmoothingloss import LabelSmoothingLoss, FocalLossWithLabelSmoothing
...
#            **config['optimizer'])
        ...
        self.criterion = FocalLossWithLabelSmoothing(len(self.vocab), padding_idx=self.vocab.pad)
